...
//		std::set<std::string> work_in_process_queue_;
		...
		void print(const unsigned int env_index, std::string status);
		void print(const unsigned int env_index, std::string status, unsigned int individual_index, unsigned int example_case);
