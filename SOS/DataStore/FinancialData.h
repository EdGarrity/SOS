...
namespace datastore
{
	...
	public:
		...
		double get_primary_stock_price(size_t index) const { return primary_adj_open_values[index]; }
		double get_index_stock_price(size_t index) const { return index_adj_open_values[index]; }
	};
